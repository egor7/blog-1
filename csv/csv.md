...
The support is also a key factor when selecting a tool. Pet projects and solutions that do not generate direct or indirect income to the developers can easily be abandoned. The vendor of q/kdb+, Kx Systems, was founded in 1993 and provides a stable background and professional support channels for kdb+ developers.
